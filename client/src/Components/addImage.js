   ...
   <>
    ...
    <div className='popUp' >
        ...
        <form>
            ...
            <p><button className='upload-btn' onClick={addSubmit}>Upload</button> <button className='upload-btn-cancel' onClick={(e)=>{e.preventDefault(); props.setAddBox(false)}}>Cancel</button></p>
